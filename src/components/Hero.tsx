...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative px-6 md:px-12 pt-16 pb-32 md:pt-20 md:pb-48 overflow-hidden">
            ...
            <div className="absolute -top-32 -right-32 h-96 w-96 bg-cyan-400/5 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-start relative z-10">
                    {/* LEFT COLUMN - TEXT */}
                    <motion.div 
                ...
                <motion.div 
                    ...
                    className="space-y-6"
                >
                    <div className="relative aspect-video md:aspect-video w-full max-w-none mx-auto rounded-xl overflow-hidden ring-1 ring-white/10 shadow-2xl bg-black">
                        {!isPlaying ? (
                            <div
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Button
                            ...
                            className="flex-1 text-xs font-black uppercase tracking-[0.25em] py-4 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-cyan-500 shadow-[0_0_30px_rgba(184,76,255,0.4)] hover:shadow-[0_0_40px_rgba(184,76,255,0.6)] transition-all rounded-xl text-center"
                        >
